(ns geteoddata.tickersLeveraged
  (:require
...
(def trading-dates (map second (map first (cheshire/parse-string (:body
                                                                  (client/get
                                                                   "https://eodhistoricaldata.com/api/eod/AAPL.US?from=2017-01-01&to=2030-01-01&api_token=OeAFFmMliFG5orCUuwAKQ8l4WWFQ67YX&period=d&fmt=json"))))))
...
;; only do these four
(def trading-universe '("SPY" "AGG" "SPXL" "GLD"))
